...
В будущем рассматривается добавление **распознавания лиц**. Это позволит идентифицировать известных людей и использовать эту информацию в автоматизациях — например, для автоматического открытия домофона, персонализированных уведомлений или выполнения других персонализированных действий.
...
- Поставьте 👍 в [соответствующей issue на GitHub](https://github.com/black-roland/homeassistant-vkcloud-vision/issues/6);
...
А если вы ищете интеграцию с распознаванием лиц для Home Assistant — [следите за обновлениями](https://t.me/mansmarthome)! В Telegram обязательно опубликую пост, когда распознавание будет готово.

*Примечание: интеграция является опенсорсной. Если вы готовы помочь в разработке — дайте знать в комментариях к issue.*
